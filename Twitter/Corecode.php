 ...
 * @link      https://github.com/jublonet/Corecode-php
 */
...
class Corecode
{
   ...
   */
  protected $_return_format = Corecode_RETURNFORMAT_OBJECT;
  ...
  /**
   * Gets the current Corecode version
   *
  ...
  /**
   * Sets if Corecode should use cURL
   *
   ...
   *                           Corecode_RETURNFORMAT_OBJECT (default)
   *                           Corecode_RETURNFORMAT_ARRAY
   *                           Corecode_RETURNFORMAT_JSON
   *
   * @return void
   */
  ...
  protected function _getCurlInitialization($url)
  {
    ...
    $this->_curl_setopt(
      ...
      'Corecode-php/' . $this->getVersion() . ' +https://github.com/jublonet/Corecode-php'
    );
  ...
  protected function _getNoCurlInitialization($url, $contextOptions, $hostname = '')
  {
    ...
    $httpOptions['header'] = [
      'User-Agent: Corecode-php/' . $this->getVersion() . ' +https://github.com/jublonet/Corecode-php'
    ];
  ...
  protected function _parseBearerReply($result, $httpstatus)
  {
    ...
    switch ($this->_return_format) {
      case Corecode_RETURNFORMAT_ARRAY:
  ...
  protected function _getRateLimitInfo($headers)
  {
    ...
    if ($this->_return_format === Corecode_RETURNFORMAT_OBJECT) {
      return (object) $rate;
    }
    return $rate;
  }
  ...
  {
    $need_array = $this->_return_format === Corecode_RETURNFORMAT_ARRAY;
    if ($reply === '[]') {
      switch ($this->_return_format) {
        case Corecode_RETURNFORMAT_ARRAY:
          return [];
