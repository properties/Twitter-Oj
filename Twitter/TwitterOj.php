...
class TwitterOj
{
   ...
   */
  protected $_return_format = TwitterOj_RETURNFORMAT_OBJECT;
  ...
  /**
   * Gets the current TwitterOj version
   *
  ...
  /**
   * Sets if TwitterOj should use cURL
   *
   ...
   *                           TwitterOj_RETURNFORMAT_OBJECT (default)
   *                           TwitterOj_RETURNFORMAT_ARRAY
   *                           TwitterOj_RETURNFORMAT_JSON
   *
   * @return void
   */
  ...
  protected function _getCurlInitialization($url)
  {
    ...
    $this->_curl_setopt(
      ...
      'TwitterOj-php/' . $this->getVersion() . ' +https://github.com/jublonet/TwitterOj-php'
    );
  ...
  protected function _getNoCurlInitialization($url, $contextOptions, $hostname = '')
  {
    ...
    $httpOptions['header'] = [
      'User-Agent: TwitterOj-php/' . $this->getVersion() . ' +https://github.com/jublonet/TwitterOj-php'
    ];
  ...
  protected function _parseBearerReply($result, $httpstatus)
  {
    ...
    switch ($this->_return_format) {
      case TwitterOj_RETURNFORMAT_ARRAY:
  ...
  protected function _getRateLimitInfo($headers)
  {
    ...
    if ($this->_return_format === TwitterOj_RETURNFORMAT_OBJECT) {
      return (object) $rate;
    }
    return $rate;
  }
  ...
  {
    $need_array = $this->_return_format === TwitterOj_RETURNFORMAT_ARRAY;
    if ($reply === '[]') {
      switch ($this->_return_format) {
        case TwitterOj_RETURNFORMAT_ARRAY:
          return [];
